...
const CreateGroupChatModal = () => {
  const { closeCreateGroupChatModal, isCreateGroupChatModalOpen } = useContext(ModalContext);
  return isCreateGroupChatModalOpen && (
    <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-30'>
      <div className='bg-white p-6 rounded shadow-lg h-[500px] w-[500px] relative'>
        ...
        <h3 className='text-center border-b border-green-500 text-2xl pb-3'>Create Group Chat</h3>
        <form action="">
          <div className='space-y-2.5 my-5'>
            <label htmlFor="groupName" className='block'>Group Name:</label>
            <input 
            type="text" 
            name="groupName" 
            id="groupName" 
